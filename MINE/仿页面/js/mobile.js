$(function(){
	...
	if($(window).innerWidth()<=1023 && $(window).innerWidth()>414){
		...
		if ($(window).innerWidth()<=414) {
				//替换第三张图
				$(".article-item:nth-of-type(1) img").attr({src :"img/mm.jpg"});
				//替换第三张图
				$(".article-item:nth-of-type(3) img:nth-of-type(1)").attr({src :"img/mm1_a.jpg"});
				$(".article-item:nth-of-type(3) img:nth-of-type(2)").attr({src :"img/mm1_b.jpg"});
				//替换第五张图
				$(".article-item:nth-of-type(5) img:nth-of-type(1)").attr({src :"img/mm2_a.jpg"});
				$(".article-item:nth-of-type(5) img:nth-of-type(2)").attr({src :"img/mm2_b.jpg"});
				//替换第八张图
				$(".article-item:nth-of-type(8) img:nth-of-type(1)").attr({src :"img/mm3_a.jpg"});
				$(".article-item:nth-of-type(8) img:nth-of-type(2)").attr({src :"img/mm3_b.jpg"});
			}
})
